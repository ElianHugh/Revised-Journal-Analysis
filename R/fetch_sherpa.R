...
fetch_sherpa <- function(combinedCite, key) {
    ...
    if (exists("parse2")) combinedPolicies <- add_case(combinedPolicies, parse2)
    if (exists("parse3")) combinedPolicies <- add_case(combinedPolicies, parse3)
    if (exists("parse4")) combinedPolicies <- add_case(combinedPolicies, parse4)
    if (exists("parse6")) combinedPolicies <- add_case(combinedPolicies, parse6)
